...
def main():
    ...
    tokenizer.pad_token_id = 0  # 添加pad eos
    tokenizer.eos_token_id = 101

    print('tokenizer.pad_token :{}'.format(tokenizer.pad_token))
    print('tokenizer.eos_token :{}'.format(tokenizer.eos_token))
